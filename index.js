...
// param arr + param str
// find the index of the str you have been given
// array.splice(index, howmany) to remove what you don't want. howmany would be 1 here and index would be the index found
// return arr AFTER splice has been made
